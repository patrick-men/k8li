...
available_resources=("po" "pod" "deploy" "deployment" "svc" "service" "ing" "ingress" "sec" "secret" "cm" "configmap" "no" "node" "tenant" "ma" "machine" "ms" "machineset" "md" "machinedeployment")
